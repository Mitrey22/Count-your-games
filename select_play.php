...
<div class="table-wrapper">
    <table class="fl-table">
        ...
        <?php
          ...
          $consulta="SELECT juegos.* FROM juegos INNER JOIN plataforma_juego ON juegos.ID=plataforma_juego.ID_juego INNER JOIN plataforma ON plataforma_juego.ID_plataforma=plataforma.ID WHERE plataforma.nombre='playstation';";
